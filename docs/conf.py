...
project = u'apply'
copyright = u'2011-2017, Stefan H. Holek'
...
latex_documents = [
  ('index', 'apply.tex', u'apply Documentation',
...
man_pages = [
    ('index', 'apply', u'apply Documentation',
     [u'Stefan H. Holek'], 1)
]
...
texinfo_documents = [
  ('index', 'apply', u'apply Documentation',
   u'Stefan H. Holek', 'apply', 'One line description of project.',
   'Miscellaneous'),
]
